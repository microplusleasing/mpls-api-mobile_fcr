    ...
    try {
        ...
        const sqlbase = `
            SELECT coll_info_monthly_view.hp_no,
                                    ...
                                    BTW.F_GET_NATIONALITY_P(CUST_INFO.IDCARD_NUM) AS NATIONALITY 
                            ...
                            FROM coll_info_monthly_view,
                                    ...
                                    WHERE (    (coll_info_monthly_view.hp_no = black1.hp(+))
                                        ...
                                        AND X_CUST_MAPPING.CUST_STATUS = '0' 
...
async function getnegotiationhistorybyid(req, res, next) {
    ...
    try {
        ...
        SELECT
            ...
            title_p.title_id,
            CASE
                WHEN COLL_INFO_MONTHLY.priority > 0 THEN '(-_-!) '
            END || '' || title_p.title_name AS tittle_name,
            CUST_INFO.name,
            CUST_INFO.sname,
            type_p.type_code,
            type_p.type_name,
        ...
        WHERE
            ...
            AND X_DEALER_P.DL_BRANCH = BRANCH_P.BRANCH_CODE (+)
            AND (
                AC_PROVE.HP_NO = COLL_INFO_MONTHLY.HP_NO (+)
